...
subprocess.call('''rm *bed6*|rm *3utr.bed|rm *5utr.bed|rm *_start.bed|rm *_cds.bed|rm *_codingexons.bed|rm *_codingintrons.bed|rm *_exons.bed|rm *_igr.bed|rm *_genome.bed|rm *_introns.bed|rm *_noncodingexons.bed|rm *_noncodingintrons.bed|rm *bam.bai|rm *sam|rm *bam_chr|rm *gappedPeak ''',shell=True)
